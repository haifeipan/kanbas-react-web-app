  ...
  return (
    <div className='col-9'>
      ...
      <textarea cols='50' rows='5' className='form-control'>
        This assignment describes how to install the development environment for
        creating andworking with Web applications we will be developing this
        semester. We will add newcontent every week. pushing the code to a
        GitHub source repository, and then deployingthe content to a remote
