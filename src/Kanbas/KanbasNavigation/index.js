...
import { faUser, faTachometerAlt, faBook, faCalendar, faEnvelope, faHistory, faVideo, faUsers, faQuestionCircle } from '@fortawesome/free-solid-svg-icons'; // Import the icons you need
    ...
    <div className="sidebar">
      {links.map((link, index) => (
        <Link
          ...
          className={`sidebar-item ${pathname.includes(link.name) ? "active-link" : ""}`}
